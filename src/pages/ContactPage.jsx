...
import { fadeUpVariant, slideLeftVariant, slideRightVariant } from '../lib/motionVariants';
            ...
            >
              ...
              {siteConfig.urgency.enabled && (
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-primary/10
                  ...
                  <span className="text-xs font-mono text-accent-primary">Accepting {siteConfig.urgency.spotsLeft} new clients in {siteConfig.urgency.month}</span>
                </div>
              )}

              <h1 className="font-display text-5xl md:text-6xl lg:text-[5rem] font-extrabold text-white mb-6 tracking-tight leading-[1.08]">Let’s build <span className="font-accent">something.</span></h1>
